 ...
 *
 */
public class FetchRandomWikiAdapter implements FetchRandomWikiPresenter.Display,DataSink,View.OnClickListener
{
    private FetchRandomWikiPresenter.FetchListener listener;
    private final DataSource datasource;
    private final View view;

    @Inject // TODO ?
    public FetchRandomWikiAdapter( final DataSource<Data> datasource, final View view ) throws IllegalArgumentException {
    ...
    @Override
    public void setFetchListener( final FetchRandomWikiPresenter.FetchListener listener ) {
    ...
    @Override public void setPosition( final int position ) {
        try {
            ...
            if ( object instanceof RandomWikiData ) {
                final RandomWikiData randomwikidata = ( RandomWikiData)object;
                final TextView textview = ( TextView )view;
                final Drawable [] drawables = textview.getCompoundDrawables();
                final Drawable drawableL = ContextCompat.getDrawable( view.getContext(),R.drawable.ic_wiki );
